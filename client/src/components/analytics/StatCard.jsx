...
const TONES = {
  purple: "bg-purple-50 border-purple-100 dark:bg-purple-500/10 dark:border-purple-500/20",
  green: "bg-green-50 border-green-100 dark:bg-green-500/10 dark:border-green-500/20",
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">
            {value}
            {suffix && <span className="text-lg font-semibold text-gray-400 dark:text-gray-500 ml-1">{suffix}</span>}
          </p>
        </div>
