    ...
    >
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded w-32" />
              </div>
              <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl ml-4" />
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-800">
            {[1, 2, 3, 4, 5].map((i) => (
              ...
              >
                {/* Dot */}
                <div className="w-2.5 h-2.5 bg-gray-200 dark:bg-gray-700 rounded-full flex-shrink-0" />
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
          ...
          <div className="w-36 h-36 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto mb-4" />
          {[1, 2, 3, 4].map((i) => (
